        ...
        <>
            <Navbar expand="sm" bg="secondary" data-bs-theme="dark">
                <Container className="px-4">
                    ...
                    {!token && <div>
                        <Button block variant="outline-light" onClick={handleShowLogin}>Login</Button>
                        <Button block variant="outline-light" className="ms-2" onClick={handleShowSignup}>Sign Up</Button>
                    </div>}
                </Container>
            </Navbar>      
