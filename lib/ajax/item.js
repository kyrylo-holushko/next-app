...
export async function getItems(bid, page, perPage) {

    const res = await fetch(`${process.env.NEXT_PUBLIC_LOCALHOST_API_URL}/items?bag=${bid}&page=${page}&perPage=${perPage}`, {
        method: "GET",
        headers: {
